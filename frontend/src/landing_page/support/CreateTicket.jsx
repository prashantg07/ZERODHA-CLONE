        ...
        <div className="container">
            <div className="row p-5 mt-5 mb-5">
                ...
                <div className="col-12 col-sm-6 col-md-4 p-3 mt-5 mb-3">
                    <h4 className=""><i className="fas fa-plus-circle"></i> Account Opening </h4>
                ...
                <div className="col-12 col-sm-6 col-md-4 p-3 mt-5 mb-3">
                    <h4 className=""><i className="far fa-user"></i> Your Zerodha Account</h4>
                ...
                <div className="col-12 col-sm-6 col-md-4 p-3 mt-5 mb-3">
                    <h4 className=""><i className="far fa-chart-bar"></i> Kite</h4>
                ...
                <div className="col-12 col-sm-6 col-md-4 p-3 mt-5 mb-3">
                    <h4 className=""><i className="fas fa-money-check"></i> Funds</h4>
                ...
                <div className="col-12 col-sm-6 col-md-4 p-3 mt-5 mb-3">
                    <h4 className=""><i className="fas fa-circle-notch"></i> Console</h4>
                ...
                <div className="col-12 col-sm-6 col-md-4 p-3 mt-5 mb-3">
                    <h4 className=""><i className="fas fa-coins"></i> Coin</h4>
